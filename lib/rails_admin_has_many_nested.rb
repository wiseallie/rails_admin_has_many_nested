...
require 'rails_admin/config/actions/has_many_setup'
...
require 'rails_admin/controller_helpers/controller_helper'
require 'rails_admin/controller_helpers/controller_extension'
